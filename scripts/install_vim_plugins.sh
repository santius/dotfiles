...
if [ ! -d ~/.vim/bundle/vim-easymotion ]; then
    log_info "Installing vim-easymotion..."
...
if [ ! -d ~/.vim/bundle/vim-indent-guides ]; then
    log_info "Installing vim-indent-guides..."
...
if [ ! -d ~/.vim/bundle/vim-smooth-scroll ]; then
    log_info "Installing vim-smooth-scroll..."
...
if [ ! -d ~/.vim/bundle/vim-css-color ]; then
    log_info "Installing vim-css-color..."
...
if [ ! -d ~/.vim/bundle/vim-startify ]; then
    log_info "Installing vim-startify..."
...
if [ ! -d ~/.vim/bundle/minimap.vim ]; then
    log_info "Installing minimap.vim..."
    ...
    if ! command -v code-minimap &> /dev/null; then
        log_info "Installing code-minimap dependency..."
        if command -v brew &> /dev/null; then
            brew install code-minimap
        else
            log_info "Please install code-minimap: https://github.com/wfxr/code-minimap"
        fi
    fi
fi
...
if [ ! -d ~/.vim/bundle/vim-devicons ]; then
    log_info "Installing vim-devicons..."
    git clone https://github.com/ryanoasis/vim-devicons.git ~/.vim/bundle/vim-devicons

    # Check if Nerd Fonts are installed
    log_info "NOTE: vim-devicons requires a Nerd Font to be installed and configured in your terminal"
    log_info "You have font-jetbrains-mono-nerd-font installed in your Brewfile, please make sure it's set in your terminal"
fi

# Install vim-cool (auto disable search highlight)
if [ ! -d ~/.vim/bundle/vim-cool ]; then
    log_info "Installing vim-cool..."
