...
# Install nord
[ -d "$HOME/.vim/bundle/nord-vim" ] || git clone https://github.com/arcticicestudio/nord-vim.git "$HOME/.vim/bundle/nord-vim"
ln -sf ~/.vim/bundle/nord-vim/colors/nord.vim ~/.vim/colors/nord.vim

# Install dracula
[ -d "$HOME/.vim/bundle/dracula" ] || git clone https://github.com/dracula/vim.git ~/.vim/bundle/dracula
ln -sf ~/.vim/bundle/dracula/colors/dracula.vim ~/.vim/colors/dracula.vim

# Install onedark
[ -d "$HOME/.vim/bundle/onedark.vim" ] || git clone https://github.com/joshdick/onedark.vim.git ~/.vim/bundle/onedark.vim
ln -sf ~/.vim/bundle/onedark.vim/colors/onedark.vim ~/.vim/colors/onedark.vim

# Install palenight
[ -d "$HOME/.vim/bundle/palenight.vim" ] || git clone https://github.com/drewtempelmeyer/palenight.vim ~/.vim/bundle/palenight.vim
ln -sf ~/.vim/bundle/palenight.vim/colors/palenight.vim ~/.vim/colors/palenight.vim

# Install tender
[ -d "$HOME/.vim/bundle/tender.vim" ] || git clone https://github.com/jacoborus/tender.vim ~/.vim/bundle/tender.vim
ln -sf ~/.vim/bundle/tender.vim/colors/tender.vim ~/.vim/colors/tender.vim

# Install catppuccin
[ -d "$HOME/.vim/bundle/catppuccin" ] || git clone https://github.com/catppuccin/vim.git ~/.vim/bundle/catppuccin
